...
def main():
    ...
    try:
        ...
        config.temp_offset = 0.062 # 8.2% offset for temperature ring, higher means more inside the circle
        ...
        plotter.create_plot(layers=[dawn_layer, temperature_layer, precipitation_layer])
